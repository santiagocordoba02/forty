        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="nav flex-column">
            <li class="nav-item">
              ...
              <a class="nav-link d-flex align-items-center gap-2 active" aria-current="page" href="factualizar.php">
                <svg class="bi"><use xlink:href="#house-fill"/></svg>
                ACTUALIZAR
              </a>
              
              <a class="nav-link d-flex align-items-center gap-2 active" aria-current="page" href="borrarform.php">
                <svg class="bi"><use xlink:href="#house-fill"/></svg>
                BORRAR
              </a>
            </li>
...
<div>
  ...
  <input type="number" name="n_producto" placeholder="numero de producto">
  <div>
